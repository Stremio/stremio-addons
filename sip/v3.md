...
addon.defineCatalog('top', function(cb) {
	cb(null, [{
		....
	}])
})

addon.defineMeta('meta', function(id, cb) {

})

addon.defineStream('stream', function(id, cb) {

})

// alternative
addon.defineCustomResource('resource', function(args, cb) {
	// args is an array of following args
})

// --publish flag would immediately publish /manifest.json and /catalog/top.json (all fully defined ones)
