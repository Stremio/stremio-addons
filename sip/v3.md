...
* Consider moving the Search to an in-house stremio service, maybe ElasticSearch; that would simplify the role of Cinemeta
...
// also could be 'define resource'
// define seems like the best term
// name: getCatalogue, onCatalogue, defineCatalogue
addon.onCatalogue(function (catalogueName) 
{
...
```
const client = new AddonClient('ipfs://..')

// TODO: should we do getCatalogues
client...
```
