...
buf.push("" + (jade.escape((jade_interp = addon.manifest.isFree ? 'Free streaming' : 'Streaming') == null ? '' : jade_interp)) + " of " + (jade.escape((jade_interp = addon.manifest.types.map(mapType).join(", ")) == null ? '' : jade_interp)) + "");
jade_debug.shift();
jade_debug.shift();
buf.push("</li>");
jade_debug.shift();
