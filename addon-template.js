...
buf.push("\n");
jade_debug.unshift(new jade.DebugItem( 44, jade_debug[0].filename ));
buf.push(".provides, .description { clear: both; }");
jade_debug.shift();
buf.push("\n");
jade_debug.unshift(new jade.DebugItem( 44, jade_debug[0].filename ));
...
buf.push("\n");
jade_debug.unshift(new jade.DebugItem( 105, jade_debug[0].filename ));
buf.push("    if (res) res.forEach(function(r) { $(\".best .posters\").append(\"<img src='\"+r.poster+\"'/>\"); });");
jade_debug.shift();
buf.push("\n");
jade_debug.unshift(new jade.DebugItem( 105, jade_debug[0].filename ));
