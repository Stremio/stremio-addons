...
buf.push("\n");
jade_debug.unshift(new jade.DebugItem( 46, jade_debug[0].filename ));
buf.push(".icon { float: left; width: 40px; height: 40px; margin: 20px; -webkit-mask-repeat: no-repeat; -moz-mask-repeat: no-repeat; -webkit-mask-position: center; -moz-mask-position: center; }");
jade_debug.shift();
buf.push("\n");
jade_debug.unshift(new jade.DebugItem( 46, jade_debug[0].filename ));
buf.push("");
...
buf.push("</div>");
jade_debug.shift();
jade_debug.unshift(new jade.DebugItem( 91, "addon-template.jade" ));
