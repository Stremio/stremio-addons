...
var jade_debug = [{ lineno: 1, filename: "addon.jade" }];
try {
var buf = [];
var jade_mixins = {};
var jade_interp;
;var locals_for_with = (locals || {});(function (RegExp, addon, endpoint) {
jade_debug.unshift({ lineno: 0, filename: "addon.jade" });
jade_debug.unshift({ lineno: 1, filename: "addon.jade" });
buf.push("<!DOCTYPE html>");
jade_debug.shift();
jade_debug.unshift({ lineno: 2, filename: "addon.jade" });
buf.push("<head>");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
jade_debug.unshift({ lineno: 3, filename: "addon.jade" });
...
jade_debug.shift();
jade_debug.unshift({ lineno: 5, filename: "addon.jade" });
buf.push("<title>");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
...
buf.push("</title>");
jade_debug.shift();
jade_debug.unshift({ lineno: 6, filename: "addon.jade" });
buf.push("<style>");
...
buf.push("</style>");
jade_debug.shift();
jade_debug.unshift({ lineno: 7, filename: "addon.jade" });
if ( (addon.manifest.background))
{
jade_debug.unshift({ lineno: 8, filename: "addon.jade" });
jade_debug.unshift({ lineno: 8, filename: "addon.jade" });
buf.push("<style>");
...
{
jade_debug.unshift({ lineno: 10, filename: "addon.jade" });
jade_debug.unshift({ lineno: 10, filename: "addon.jade" });
buf.push("<style>");
...
jade_debug.shift();
jade_debug.unshift({ lineno: 11, filename: "addon.jade" });
buf.push("<body>");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
jade_debug.unshift({ lineno: 12, filename: "addon.jade" });
buf.push("<div id=\"addon\">");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
jade_debug.unshift({ lineno: 13, filename: "addon.jade" });
if ( (addon.manifest.logo))
{
jade_debug.unshift({ lineno: 14, filename: "addon.jade" });
jade_debug.unshift({ lineno: 14, filename: "addon.jade" });
...
{
jade_debug.unshift({ lineno: 16, filename: "addon.jade" });
jade_debug.unshift({ lineno: 16, filename: "addon.jade" });
buf.push("<h2>");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
...
jade_debug.shift();
jade_debug.unshift({ lineno: 17, filename: "addon.jade" });
buf.push("<h3>");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
...
buf.push("</h3>");
jade_debug.shift();
jade_debug.unshift({ lineno: 18, filename: "addon.jade" });
buf.push("<h3 class=\"provides\">");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
jade_debug.shift();
buf.push("</h3>");
jade_debug.shift();
jade_debug.unshift({ lineno: 19, filename: "addon.jade" });
if ( endpoint)
{
jade_debug.unshift({ lineno: 20, filename: "addon.jade" });
jade_debug.unshift({ lineno: 20, filename: "addon.jade" });
buf.push("<a" + (jade.attr("href", "" + (endpoint ? endpoint.replace(/^http(s?)/, 'stremio') : null) + "", true, true)) + " class=\"activate-link\">");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
jade_debug.unshift({ lineno: 21, filename: "addon.jade" });
...
{
jade_debug.unshift({ lineno: 23, filename: "addon.jade" });
jade_debug.unshift({ lineno: 23, filename: "addon.jade" });
buf.push("<div>");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
...
buf.push("</div>");
jade_debug.shift();
jade_debug.unshift({ lineno: 24, filename: "addon.jade" });
buf.push("<script src=\"https://code.jquery.com/jquery-2.1.4.min.js\">");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
jade_debug.shift();
buf.push("</script>");
jade_debug.shift();
jade_debug.unshift({ lineno: 25, filename: "addon.jade" });
buf.push("<script src=\"http://www.strem.io/js/stremio-addons.min.js\">");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
jade_debug.shift();
buf.push("</script>");
jade_debug.shift();
jade_debug.unshift({ lineno: 26, filename: "addon.jade" });
if ( endpoint)
{
jade_debug.unshift({ lineno: 27, filename: "addon.jade" });
jade_debug.unshift({ lineno: 27, filename: "addon.jade" });
buf.push("<script>");
